        ...
        <div class="conteiner mt-4"></div>
				...
				<div class="row mx-3 mt-4 text-light">
					...
					<div id="user-info" data-default-image="../../static/img/pf.jpg" class="col-2 text-center bg-dashboard shadow rounded">
						<img id="user-image" class="mt-3 img-fluid">
					...
					<div class="col-6 mx-auto bg-dashboard shadow rounded text-center">
						<div class="bg-dashboard-2 mb-4 mt-3 mx-2 rounded shadow h-6vh"><h5>Historico de Jogos</h5></div>
					...
					<div class="col-3 bg-dashboard shadow rounded text-center">
						<div class="bg-dashboard-2 mb-4 mt-3 mx-2 rounded shadow h-6vh"><h5>Online Friends</h5></div>
				...
				<div class="row mt-4 mb-4 mx-3 bg-dashboard shadow rounded h-10vh d-flex justify-content-center align-items-center">
					<div class="col-3"></div>
