class PongGame {
    static Game = class {
        ...
        updateAI() {
            ...
            // Limita a posição da raquete da IA à borda do canvas
            if (this.player2.y < 0) this.player2.y = 0;
            if (this.player2.y > this.canvas.height - this.paddleHeight) this.player2.y = this.canvas.height - this.paddleHeight;
        }
        ...
        checkWin() {
            ...
            if (this.player1.wins >= this.totalGames / 2 || this.player2.wins >= this.totalGames / 2) {
                this.winner = this.player1.wins > this.player2.wins ? 'Jogador 1' : 'Jogador 2 (IA)';
                this.messageElement.textContent = `O vencedor é: ${this.winner}`;
            }
        }
        ...
        draw() {
            ...
            this.ctx.fillText(`Jogador 2 (IA): ${this.player2.score} (Vitórias: ${this.player2.wins})`, 3 * this.canvas.width / 4 - 100, 50);
